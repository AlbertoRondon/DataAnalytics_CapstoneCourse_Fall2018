...
Study: Focks DA, Barrera R (2007) Dengue transmission dynamics: Assessment and implications for control. Geneva: TDR/World Health Organization. 92–109 p.
...
Dengue_model <- lm (Cases_conf ~ Rain + Avg_temp + Min_temp + Max_temp, data = Dengue)
summary(Dengue_model)

#General Multiple Linear Regression - Log Cases#
Dengue_model_log <- lm (Cases_conf ~ Rain + Avg_temp + Min_temp + Max_temp, data = Dengue_log)
...
Dengue_model_log_2 <- lm (Cases_conf ~ Rain + Avg_temp + Min_temp, data = Dengue_log)
